...
\begin{enumerate}
\item \textbf{Answer still needs to be found.}
...
\item Algorithm 4 (orange) slope is $\frac{\log(.000151000000002/.0000660000000003}{700/400} = .2054$
\end{enumerate}
